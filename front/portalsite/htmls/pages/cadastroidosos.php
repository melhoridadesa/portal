...
<html lang="pt-br" ng-app="app">
  ...
  <body>
    ...
    <div>
    	<form method="">
        <label> Cadastro de idosos: </label>
        <br />
      		<input type="text" ng-model="nome" name="nome" placeholder="Digite seu nome completo" /> <br />
          <input type="text" ng-model="endereco" name="endereco" placeholder="Digite seu Endereco" /><br />
          <input type="email" ng-model="email" name="email" placeholder="Digite seu email" /><br />
